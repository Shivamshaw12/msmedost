      ...
      <div class="page-banner home-banner">
        <div class="row align-items-center flex-wrap-reverse h-100">
          <div class="col-md-6 py-5 wow fadeInLeft">
            <h1 class="mb-4">Professional Tax</h1>
            <p class="text-lg text-grey mb-5">Professional tax is a tax that is levied by a state government on all individuals who earn a living through any medium. This should not be confused with the definition of professionals that indicates people such as doctors. This is a tax that is to be paid by every single earning individual.</p>
