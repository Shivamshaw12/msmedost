      ...
      <div class="page-banner home-banner">
        <div class="row align-items-center flex-wrap-reverse h-100">
          <div class="col-md-6 py-5 wow fadeInLeft">
            ...
            <p class="text-lg text-grey mb-5">Great software development starts with better visibility. Measure and improve your organization's DevOps performance with real-time delivery insights.</p>
