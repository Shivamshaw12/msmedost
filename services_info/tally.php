      ...
      <div class="page-banner home-banner">
        <div class="row align-items-center flex-wrap-reverse h-100">
          <div class="col-md-6 py-5 wow fadeInLeft">
            <h1 class="mb-4">Tally</h1>
            <p class="text-lg text-grey mb-5">Tally is a technology & innovation company, delivering business software for SMBs for over 3 decades.</p>
